        ...
        <div class="widget red">
          ...
          ?>
            ...
            <div class="widget-title">
              <?php
              if ($_SESSION['aksi'] == "5") { //diganti jadi koreksi upload
              ...
              ?>
              <p style="font-weight: bold; font-size: 15px; color: white; padding-top: 8px; padding-left: 2px;">Ganti Jadi Upload</p>
              <span class="tools">
