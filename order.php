            ...
            <div class="row-fluid">
                ...
                <div class="widget red">
                    ...
                    <div class="widget-body">
                        ...
                        <form class="cmxform form-horizontal submitCustomer" id="commentForm" method="POST" action="action/customer/simpanPlg.php" enctype="multipart/form-data">
                            ...
                            <div class="control-group ">
                                ...
                                <div class="controls">
                                    <input class="span12" id="nama" name="nama" type="text"  placeholder="Nama Customer" autocomplete="off" onkeydown="upperCaseF(this)" required="true" />
                                </div>
                            </div>
                            <div class="control-group ">
                            ...
                            <div class="form-actions">
                                <button class="btn btn-success" type="submit" id="simpanCS"><i class="icon-save"></i> Simpan</button>
                        ...
                        <form class="cmxform form-horizontal submitCustomer" id="commentForm" method="POST" action="action/customer/simpanPlg.php" enctype="multipart/form-data">
                            ...
                            <div class="form-actions">
                                <button class="btn btn-info" type="submit" id="simpanCS"><i class="icon-save"></i> Tambah</button>
              ...
              <div id="addModalMasuk" class="modal modal-form hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                  ...
                  <form class="cmxform form-horizontal" id="submitBarang" action="action/barang/simpanBarang.php" method="POST" >
                      <div class="modal-body modal-full tinggi">
                          ...
                          <div class="control-group ">
                              <label for="NOurut" class="control-label"><strong>Nomor Urut</strong><p class="titik2">:</p></label>
                              <div class="controls">
                                  <input class="span12 " id="NOurut" name="NOurut" type="text"  placeholder="Nomor Urut" maxlength="5" onkeydown="validAngka(this)"/>
                              </div>
                          </div>
                          <div class="control-group ">
                              <label for="KDbarang" class="control-label"><strong>Kode Barang</strong><p class="titik2">:</p></label>
                              <div class="controls">
                                  <input class="span12 " id="KDbarang" name="KDbarang" type="text"  placeholder="Kode Barang" maxlength="20" onkeydown="upperCaseF(this)"/>
                              </div>
                          </div>
                          <div class="control-group ">
                              <label for="barang" class="control-label"><strong>Nama Barang</strong><p class="titik2">:</p></label>
                              <div class="controls">
              ...
              <div id="editModalBarang" class="modal modal-form hide fade " tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                  ...
                  <form class="cmxform form-horizontal" id="editBarangForm" action="action/barang/editBarang.php" method="POST" >
                      <div class="modal-body modal-full tinggi">
                          ...
                          <div class="control-group ">
                              <label for="editNOurut" class="control-label"><strong>Nomor Urut</strong><p class="titik2">:</p></label>
                              <div class="controls">
                                  <input class="span12 " id="editNOurut" name="editNOurut" type="text"  placeholder="Nomor Urut" maxlength="5" onkeydown="validAngka(this)"/>
                              </div>
                          </div>
                          <div class="control-group ">
                              <label for="editKDbarang" class="control-label"><strong>Kode Barang</strong><p class="titik2">:</p></label>
                              <div class="controls">
                          ...
                          <div class="control-group ">
                              <label for="editBarang" class="control-label"><strong>Nama Barang</strong><p class="titik2">:</p></label>
                              <div class="controls">
...
<?php require_once 'include/footer.php'; ?>
  ...
  <script src="jsAction/order.js"></script>
