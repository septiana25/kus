...
<div id="main-content">
    ...
    <div class="container-fluid">
                        ...
                        <div class="tabbable custom-tab">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab_1_1">
                                    ...
                                    <table class="table table-striped table-bordered" id="tabelKoreksiPlus">
                                        <thead>
                                            <tr>
                                ...
                                <div class="tab-pane" id="tab_1_2">
                                    <p>Form Upload Koreksi Plus</p>

                                    <form class="form-horizontal" method="POST" id="submitUploadKoreksiPlus" enctype="multipart/form-data">
                                        <div class="control-group">
                                            <label class="control-label">File CSV </label>
                                            <div class="controls">
                                                <input class="span12" type="hidden" id="type" name="type" value="2" readonly>
        ...
        <!-- END MODAL HAPUS KOREKSI PLUS-->
        <!-- BEGIN MODAL DISABLE KOREKSI PLUS-->
    ...
    <script src="jsAction/uploadkoreskiplus.js"></script>