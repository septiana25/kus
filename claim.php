            ...
            <!-- BEGIN MODAL MASUK-->
              <div id="myModal1" class="modal modal-form-tinggi hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                  <div class="modal-header">
                      ...
                      <h3 id="myModalLabel1" class="center"><i class="icon-plus-sign"></i> FORM INPUT CLAIM</h3>
                  </div>
                  <form class="cmxform form-horizontal" id="submitClaim" action="action/claim/simpanClaim.php" method="POST" >
                      <div class="modal-body modal-full tinggi">
                          <div class="control-group">
                              <label class="control-label"><strong>No Faktur Claim</strong><p class="titik2">:</p></label>
                              <div class="controls">
                                <select onchange="getId(this.value);" id="noClaim" name="noClaim" class="choiceChosen" data-placeholder="Pilih Faktur Claim..." >
                                <option value=""></option>
                                <?php
                                $fak = "SELECT id_klr, no_faktur FROM keluar JOIN detail_keluar USING(id_klr) WHERE no_faktur!='0' AND claim='0' GROUP BY no_faktur DESC";
                                $fak1 = $koneksi->query($fak);
                                while ($fak2 = $fak1->fetch_array()) {
                                  echo "<option value='$fak2[0]'>$fak2[1]</option>";
                                }
                                ?>
                                </select>
                              </div>
                          ...
                          <div class="control-group">
                              ...
                              <div class="controls">
                                <select id="nama" name="pengirim" class="choiceChosen" data-placeholder="Pilih Nama Pengirim..." >
                                <option value=""></option>
                                <?php
                            ...
                            <table class="table" id="tabelBarangKeluar">
                              ...
                              <tbody>
                                    <tr>
                                      <td>
                                        <div >
                                          <select id="id_brg" name="id_brg" class="input-xlarge m-wrap" data-placeholder="Pilih Type Ban..." >
                                          <option value=""></option>
                      ...
                      <div class="modal-footer">
                          <button class="btn btn-primary" id="simpanClaimBtn" type="submit" data-loading-text="Loading..." autocomplete="off" ><i class="fa fa-floppy-o"></i> Simpan</button>
