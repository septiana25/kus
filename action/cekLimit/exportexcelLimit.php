...
$SI->setCellValue('A1', 'LAPORAN BUFFER STOCK GUDANG PT.KHARISMA UTAMA SENTOSA'); //Judul laporan
...
//Memberi nama sheet
$excelku->getActiveSheet()->setTitle('Laporan-Buffer-Stock-'.TanggalIndo($tgl));

$excelku->setActiveSheetIndex(0);

// untuk excel 2007 atau yang berekstensi .xlsx
header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
header('Content-Disposition: attachment;filename=Laporan-Buffer-Stock-'.TanggalIndo($tgl).'.xlsx');
