...
$excelku->getActiveSheet()->getColumnDimension('AH')->setWidth(15);
$excelku->getActiveSheet()->getColumnDimension('AI')->setWidth(15);
$excelku->getActiveSheet()->getColumnDimension('AJ')->setWidth(15);
$excelku->getActiveSheet()->getColumnDimension('AK')->setWidth(20);

// Mergecell, menyatukan beberapa kolom
$excelku->getActiveSheet()->mergeCells('A1:AK1');
$excelku->getActiveSheet()->mergeCells('A2:AK2');
$excelku->getActiveSheet()->mergeCells('F3:AG3');
...
$excelku->getActiveSheet()->mergeCells('AH3:AH4');
$excelku->getActiveSheet()->mergeCells('AI3:AI4');
$excelku->getActiveSheet()->mergeCells('AJ3:AJ4');
...
$SI->setCellValue('AH3', 'T.ADJUSMEN'); //Kolom
$SI->setCellValue('AI3', 'T.KELUAR'); //Kolom
$SI->setCellValue('AJ3', 'S.AKHIR'); //Kolom
$SI->setCellValue('AK3', 'KODE'); //Kolom
//Mengeset Syle nya
...
$excelku->getActiveSheet()->setSharedStyle($headerStylenya, "A3:AK3");
$excelku->getActiveSheet()->setSharedStyle($headerStylenya, "A4:AK4");
...
$strsql = "SELECT s.brg, s_awal, IFNULL(total_masuk, NULL) AS b_masuk,
          ...
          adjusmen, IFNULL(total_keluar, NULL) AS total_keluar, s_akhir, kat, s.kdbrg
        FROM(
...
while ($row = $res->fetch_assoc()) {
  ...
  $SI->setCellValue("AH".$baris,$row['total_keluar']); //mengisi data untuk TELP
  $SI->setCellValue("AI".$baris,$row['total_keluar']); //mengisi data untuk TELP
  $SI->setCellValue("AJ".$baris,$row['s_akhir']); //mengisi data untuk TELP
  $SI->setCellValue("AK".$baris,$row['kdbrg']); //mengisi data untuk TELP
  ...
  $tgl_27 +=$row['tgl_27'];
  $tgl_28 +=$row['tgl_28'];
  $t_akhir +=$row['adjusmen'];
  $s_akhir +=$row['total_keluar'];
  $s_akhir +=$row['s_akhir'];
...
$SI->setCellValue("AH".$baris,$adj); //mengisi data untuk TELP
$SI->setCellValue("AI".$baris,$s_akhir); //mengisi data untuk TELP
$SI->setCellValue("AJ".$baris,$s_akhir); //mengisi data untuk TELP

//Membuat garis di body tabel (isi data)
$excelku->getActiveSheet()->setSharedStyle($bodyStylenya, "A5:AK$baris");
