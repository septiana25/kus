...
$SI->setCellValue('AJ3', 'T.MASUK'); //Kolom
...
$excelku->getActiveSheet()->setSharedStyle($headerStylenya, "F3:AJ3");
...
while ($row = $res->fetch_assoc()) {
  ...
  $SI->setCellValue("AJ".$baris,$row['b_masuk']); //mengisi data untuk TELP
...
$SI->setCellValue("AJ".$baris,$b_masuk); //mengisi data untuk TELP
