...
$SI->setCellValue('AK3', 'T.MASUK'); //Kolom
...
$excelku->getActiveSheet()->setSharedStyle($headerStylenya, "F3:AK3");

//Menggunakan HeaderStylenya
$excelku->getActiveSheet()->setSharedStyle($headerStylenya, "A3:AL3");
$excelku->getActiveSheet()->setSharedStyle($headerStylenya, "A4:AL4");
...
$strsql = "SELECT s.brg, s_awal, IFNULL(total_keluar, NULL) AS total_keluar,
            ...
            tgl_29, tgl_30, tgl_31, IFNULL(total_masuk, NULL) AS b_masuk, s_akhir, kat
          FROM(
...
while ($row = $res->fetch_assoc()) {
  ...
  $SI->setCellValue("AK".$baris,$row['b_masuk']); //mengisi data untuk TELP
...
$SI->setCellValue("AK".$baris,$b_masuk); //mengisi data untuk TELP
