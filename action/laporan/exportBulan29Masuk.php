...
$excelku->getActiveSheet()->mergeCells('A1:AJ1');
$excelku->getActiveSheet()->mergeCells('A2:AJ2');
$excelku->getActiveSheet()->mergeCells('F3:AH3');
...
$SI->setCellValue('A1', 'LAPORAN TANSAKSI MASUK GUDANG PT.KHARISMA UTAMA SENTOSA'); //Judul laporan
...
$SI->setCellValue('E3', 'B.KELUAR'); //Kolom B.Masuk
...
$SI->setCellValue('AI4', 'T.MASUK'); //Kolom
...
$excelku->getActiveSheet()->setSharedStyle($headerStylenya, "F3:AI3");

//Menggunakan HeaderStylenya
$excelku->getActiveSheet()->setSharedStyle($headerStylenya, "A3:AJ3");
$excelku->getActiveSheet()->setSharedStyle($headerStylenya, "A4:AJ4");

// Mengambil data dari tabel
$strsql = "SELECT s.brg, s_awal, IFNULL(total_keluar, NULL) AS total_keluar,
            ...
            tgl_29, IFNULL(total_masuk, NULL) AS b_masuk, s_akhir, kat
          FROM(
...
while ($row = $res->fetch_assoc()) {
  ...
  $SI->setCellValue("E".$baris,$row['total_keluar']); //mengisi data untuk TELP
  ...
  $SI->setCellValue("AI".$baris,$row['b_masuk']); //mengisi data untuk TELP
...
$SI->setCellValue("E".$baris,$t_akhir);
...
$SI->setCellValue("AI".$baris,$b_masuk); //mengisi data untuk TELP
$SI->setCellValue("AJ".$baris,$s_akhir); //mengisi data untuk TELP

//Membuat garis di body tabel (isi data)
$excelku->getActiveSheet()->setSharedStyle($bodyStylenya, "A5:AJ$baris");
