...
$start = $time;
?>
<form name="myForm" id="myForm" onSubmit="return validateForm()" action="importFaktur.php" method="post" enctype="multipart/form-data">
...
//       membaca data (kolom ke-1 sd terakhir)
      $no_faktur = $data->val($i, 1);
      $pengirim  = $data->val($i, 2);
      $ket       = $data->val($i, 3);

//      setelah data dibaca, masukkan ke tabel pegawai sql
      $query = $koneksi->query("INSERT INTO keluar (no_faktur, pengirim, tgl,ket)values('$no_faktur','$pengirim','$tgl','$ket')");
