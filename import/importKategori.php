...
$start = $time;
?>
<form name="myForm" id="myForm" onSubmit="return validateForm()" action="importKategori.php" method="post" enctype="multipart/form-data">
...
//      setelah data dibaca, masukkan ke tabel pegawai sql
      $query = $koneksi->query("INSERT into kat (kat)values('$kat')");
