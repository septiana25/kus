...
$start = $time;
?>
<h3>IMPORT DATA MASUK, DETAIL MASUK, SALDO</h3>
...
//    import data excel mulai baris ke-2 (karena tabel xls ada header pada baris 1)
    $detail_brg = "INSERT INTO detail_brg (id, id_brg, id_rak) VALUES ";
    $query      = "INSERT INTO masuk (id_msk, id, tgl) VALUES ";
    $detMsk     = "INSERT INTO detail_masuk (id_det_msk, id_msk, jam, jml_msk) VALUES ";
    $sldo       = "INSERT INTO saldo (id_saldo, id, tgl, saldo_awal, saldo_akhir) VALUES ";
    for ($i=2; $i<=$baris; $i++)
    {
...
//      setelah data dibaca, masukkan ke tabel pegawai sql
      $detail_brg .= "('$id','$id_brg','$id_rak'),";
      
      $query      .= "('$id','$id', '2017-10-17'),";
      
      $detMsk     .= "('$id', '$id', '10:00:00', '$saldo'),";
      
      $sldo       .= "('$id', '$id', '2017-10-17', '0', '$saldo'),";
...
//      pada prakteknya sleep dihapus aja karena bikin lama hehe
    ...
    if ($koneksi->query($detail_brg) === TRUE) {

         if ($koneksi->query($query) === TRUE) {

            if ($koneksi->query($detMsk) === TRUE) {

              if ($koneksi->query($sldo) === TRUE) {
                echo "Data Berhasil Disimpan<br/>";
              }else{
                echo "Data Gagal Disimpan Di tabel SALDO <br/> ".$koneksi->error;
              }

            }else{
              echo "Data Gagal Disimpan Di tabel DETAIL MASUK<br/> ".$koneksi->error;
            }

         }else{
          echo "Data Gagal Disimpan Di tabel MASUK<br/> ".$koneksi->error;
         }

    }else{
      echo "Data Gagal Disimpan Di tabel DETAIL BARANG <br/> ".$koneksi->error;
    }
