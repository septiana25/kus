      ...
      <div class="sidebar-scroll">
          <div id="sidebar" class="nav-collapse collapse">
              ...
              <ul class="sidebar-menu">
                  ...
                  <?php
                  if ($_SESSION['level'] == 'administrator' | $_SESSION['level'] == 'claim') {
                    echo '
                          <li class="sub-menu" id="activeClaim">
                              ...
                              <ul class="sub">
                                  ...
                                  <li id="activePenggantian"><a class="" href="claim.php">Data Claim</a><i class="icon-circle-arrow-right kanan"></i></li>
                                  <li id="activeToko"><a class="" href="barangMsk.php">Data Toko</a><i class="icon-circle-arrow-right kanan"></i></li>
                              </ul>
                          </li>
                    ...
                    echo '
                        <li class="sub-menu" id="activeSetting">
                            ...
                            <ul class="sub">
                                ...
                                <li id="activeBackup"><a class="" href="backup.php">Backup Database</a><i class="icon-circle-arrow-right kanan"></i>
