...
<div id="main-content">
    ...
    <div class="container-fluid">
                        ...
                        <div class="tabbable custom-tab">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab_1_1">
                                    ...
                                    <table class="table table-striped table-bordered" id="tabelKoreksiMinus">
                                        <thead>
                                            <tr>
                                ...
                                <div class="tab-pane" id="tab_1_2">
                                    <p>Form Upload Koreksi Minus</p>

                                    <form class="form-horizontal" method="POST" id="submitUploadKoreksiMinus" enctype="multipart/form-data">
        ...
        <!-- END MODAL HAPUS KOREKSI MINUS-->
        <!-- BEGIN MODAL DISABLE KOREKSI MINUS-->
