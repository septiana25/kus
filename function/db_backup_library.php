...
*/			
	class db_backup{
		...
		public function backup(){
			...
			/*$table_sql[]  = array("kat", "barang", "rak", "detail_brg", "masuk", "keluar", "saldo", "detail_masuk", "detail_keluar", "pengirim", "user", "log");*/
		...
		public function download($name='backup_KTA_'){
			/*//Download
			...
			header('Content-Disposition: attachment; filename='.$name.date('Y-m-d').'.sql');
		...
		public function save($path,$name=""){
			$name = ($name != "") ? $name : 'backup_KUS_' . date('Y-m-d');
		...
		public function tables(){
			...
			$tables= array("kat", "barang", "rak", "detail_brg", "masuk", "keluar", "saldo", "detail_masuk", "detail_keluar", "toko", "user", "tblLimit", "log");
