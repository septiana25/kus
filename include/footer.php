   ...
   <!-- BEGIN FOOTER -->
   <div id="footer">
       &copy; All rights reserved <a style="font-weight: bold;">Ian Septiana.</a>  Aplikasi Inventori Gudang. V.4.00
       <!-- V.3.03 Tambah Event Kalender di Dashboard -->
   </div>
   <!-- END FOOTER -->
  ...
  <!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-3-typeahead/4.0.2/bootstrap3-typeahead.min.js"></script> -->
   ...
   <!-- <script src="assets/jquery.hotkeys-master/jquery.hotkeys.js"></script> -->
   ...
   <!--script for this page only-->
   <!-- <script src="assets/js/all-chartjs.js"></script> -->
   <!-- END JAVASCRIPTS -->   
</body>
<!-- END BODY -->
</html>