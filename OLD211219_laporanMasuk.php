...
<?php
  ...
  if ($hari == 31) {
    require_once 'action/laporan/bulan_31Masuk.php';
  }
  elseif ($hari == 30) {
    require_once 'action/laporan/bulan_30Masuk.php';
  }
  elseif ($hari == 29) {
    require_once 'action/laporan/bulan_29Masuk.php';
  }
  elseif ($hari == 28) {
    require_once 'action/laporan/bulan_28Masuk.php';
  }
