<?php require_once 'function/koneksi.php';
      ...
      //query rak
        ...
        echo "<div class='div-request div-hide'>notaTolakan</div>";
?>
      <!-- BEGIN PAGE -->  
      <div id="main-content">
                      ...
                      <div class="modal-body modal-full tinggi">
                          ...
                          <div class="control-group">
                            <table width="100%" role="none">
                              <tr>
                                <td>
                                  <input class="input-xlarge " id="toko" name="toko" type="text"  placeholder="Nama Toko" readonly="true" />
                                </td>
                                <td>
                                  <input class="input-xlarge " id="barang" name="barang" type="text"  placeholder="Nama Barang" readonly="true" />
                                </td>
                              </tr>
                            </table>
                          </div>
                          <div class="control-group">
                            <table class="table table-striped table-bordered" id="tableNotaTolak">
                              <thead>
                                <tr>
                                  <th >No</th>
                                  <th >Ukuran</th>
            ...
            <div class="row-fluid">
                ...
                <div class="widget red">
                    ...
                    <div class="widget-body">
                        <table class="table table-striped table-bordered" id="tableNotaTolakan">
                            <thead>
                            <!-- <tr>
                              <th colspan="5"></th>
...
<?php require_once 'include/footer.php'; ?>
    ...
    <script src="jsAction/notaTolakan.js"></script> 
    <?php 
    }else{
