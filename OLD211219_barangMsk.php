            ...
            <div class="row-fluid">
                ...
                <div class="widget red">
                    <div class="widget-title">
                        <a href="#myModal1" role="button" class="btn btn-primary tambah" id="addBarangMskBtnModal" data-toggle="modal"> <i class=" icon-plus"></i>Tambah Data</a>
                            <span class="tools">
                  ...
                  <form class="cmxform form-horizontal" id="submitBarangMsk" action="action/barangMasuk/simpanMasuk.php" method="POST" >
                      <div class="modal-body modal-full tinggi2">
                          ...
                          <div class="control-group" style="margin-bottom: 15px;">
                              <label class="control-label"><strong>Nama Barang</strong><p class="titik2">:</p></label>
                              <div class="controls">
                          ...
                          <div class="control-group" style="margin-bottom: 15px;">
                              <label class="control-label"><strong>Lokasi Rak</strong><p class="titik2">:</p></label>
                              <div class="controls">
                          ...
                          <div class="control-group" style="margin-bottom: 15px;">
                              <label for="cname" class="control-label"><strong>Keterangan</strong><p class="titik2">:</p></label>
                              <div class="controls">
                                  <input class="span12 " id="ket" name="ket" type="text"  placeholder="Input Keterangan" onkeydown="HurufBesar(this)"/>
                              </div>
                          </div>
                          <div class="control-group" style="margin-bottom: 15px;">
                              <label for="cname" class="control-label"><strong>Jumlah</strong><p class="titik2">:</p></label>
                              <div class="controls">
